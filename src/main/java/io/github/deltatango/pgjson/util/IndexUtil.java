...
public class IndexUtil {
     ...
     */
    private void detectIndexes(String currentPath, JsonObject properties, Map<String, String> indexes, String parentPath) {
        for (String key : properties.keySet()) {
            try {
                ...
                if (property.has("properties")) {
                    ...
                    detectIndexes(key, nestedProperties, indexes, propertyPath);
                }
